 ...
 * Language Cookie.
 *
 * For the cookie to be set properly on cached pages, the
 * variable page_cache_invoke_hooks has to be set to TRUE.
...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/millboard/millboard-settings.inc';
}
...
// Enabling production split in prod environment.
if (isset($_ENV['AH_SITE_ENVIRONMENT']) && $_ENV['AH_SITE_ENVIRONMENT'] == 'prod') {
  $config["config_split.config_split.production"]["status"] = TRUE;
}
elseif (isset($_ENV['AH_SITE_ENVIRONMENT']) && $_ENV['AH_SITE_ENVIRONMENT'] == 'stage') {
