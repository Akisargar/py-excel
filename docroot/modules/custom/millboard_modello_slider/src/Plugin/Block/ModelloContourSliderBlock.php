...
class ModelloContourSliderBlock extends BlockBase {
  ...
  public function build() {
    ...
    $images = [
      [
        'top_image' => '/modules/custom/millboard_modello_slider/img/contour/Design 11.5..jpg',
        'nav_image' => '/modules/custom/millboard_modello_slider/img/contour/Design 11.13..jpg',
      ],
      [
        'top_image' => '/modules/custom/millboard_modello_slider/img/contour/Design 11.5..jpg',
        'nav_image' => '/modules/custom/millboard_modello_slider/img/contour/Design 11.13..jpg',
    ...
    $slider_html = '<div class="coh-style-container-small coh-style-inner-container-padding laying-pattern">
      <h3 class="text-align-center"><strong>' . t('CONTOUR LAYING PATTERNS') . '</strong></h3>
